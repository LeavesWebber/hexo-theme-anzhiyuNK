hexo.extend.filter.register(
  ...
  () => {
    const defaultConfig = {
      ...
      favicon: "/favicon.png",
      avatar: {
        img: "/img/avatar-1024x1024.webp",
        effect: false,
      },
      disable_top_img: false,
      index_img: false,
      default_img: "/img/loading.webp",
      ...
      error_404: {
        ...
        background: "/img/645907596997d.gif",
      },
      post_meta: {
        page: {
          date_type: "created",
      ...
      post_copyright: {
        ...
        avatarSinks: true,
        copyright_author_img_back: "/img/author_back.webp",
        copyright_author_img_front: "/img/author_front.webp",
      ...
      noticeOutdate: {
        ...
        limit_day: 300,
        position: "top",
        message_prev: "本篇文章距离创建时间已过",
        message_next: "天,不保证内容可用性.",
      },
      footer: {
        owner: {
          enable: true,
        ...
        runtime: {
          enable: false,
          launch_time: "06/11/2021 00:00:00",
